...
const Page = () => {
    const { idioma, idiomas, pergunta } = usePage().props;

    const { data, setData, post, errors } = useForm(pergunta);

    const breadcrumbItems = [
        { label: "Perguntas frequentes", link: "Manager.Perguntas.index" },
    ];
    ...
    const handleSubmit = (e) => {
        ...
        post(
            route("Manager.Perguntas.atualizar", {
                id: pergunta.id,
                lang: idioma_url,
            }),
            {
