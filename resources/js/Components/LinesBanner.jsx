...
export const LinesBanner = ({ current, lines, onChangeSlug }) => {
    ...
    return (
        <section
            ...
            aria-labelledby="lines-banner-title"
        >
            <div className="absolute inset-0 bg-black/40" aria-hidden="true" />

            <div className="container max-w-large relative">
                <nav
                    className="hidden md:block relative pr-30"
                    aria-label={lang("navegacaoLinhas")}
                >
                    <div
                        className="absolute w-3/5 max-w-[850px] left-0 -bottom-2 border-b border-neutral-600"
                        aria-hidden="true"
                    />
                ...
                <div className="mt-8 md:mt-[8%] max-w-2xl px-4 md:px-0">
                    <h3
                        className="text-3xl md:text-4xl 2xl:text-[45px] leading-tight md:leading-none text-secondary mb-6 md:mb-8 text-balance max-w-lg"
                        id="lines-banner-title"
                    >
                        {current.chamada}
                    </h3>
                    <div
